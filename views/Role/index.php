...
/* @var $searchModel app\models\MRoleSearch */
/* @var $dataProvider yii\data\ActiveDataProvider */

$this->title = 'role';
$this->params['breadcrumbs'][] = $this->title;
?>
<div class="mrole-index">
    <div class="row">
        <div class="col-lg-12">
    ...
    $(document).ready(function(){
       $('#user-grid').on('pjax:beforeSend', function(a, b, c){
        ...
        $('#edit').click(function(){
            ...
            var url = window.location.protocol + '//' + window.location.host + '/myproject/web/role/update?id='+id;
